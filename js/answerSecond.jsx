...
class AnswerSecondTeam extends React.Component {
    state = {
        answer: ''
    };
    ...
    handleSubmit = (event) => {
        ...
        if (typeof this.props.updateAnswerSecond === 'function') {
            this.props.updateAnswerSecond(this.state.answer)
        }
    };
...
export default AnswerSecondTeam;