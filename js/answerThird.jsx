...
class AnswerThirdTeam extends React.Component {
    state = {
        answer: ''
    };
    ...
    handleSubmit = (event) => {
        ...
        if (typeof this.props.updateAnswerThird === 'function') {
            this.props.updateAnswerThird(this.state.answer)
        }
    };
...
export default AnswerThirdTeam;